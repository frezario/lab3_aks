...
int main(int argc, char **argv) {
    ...
    int function_number, thread_count;
    ...
    auto res = integrals::calculate_integral_parallel(thread_count, functions[function_number - 1], config["abs_err"],
                                                      config["rel_err"],
                                                      config["x_start"],
                                                      config["x_end"],
...
//    auto res = integrals::calculate_integral(functions[function_number - 1], config["abs_err"],
//                                                      config["rel_err"],
//                                                      config["x_start"],
//                                                      config["x_end"],
//                                                      config["y_start"], config["y_end"],
